...
public class DdNode extends SdNode {
    ...
    public DdSource s(){return (DdSource)source;}
    ...
    private static final int STYLE_VIDEO = 11;
    private static final int STYLE_AUDIO = 12;

    public DdNode(SdSource source){super(source);}
...
//        return run.contains("outweb");
//    }

//    public String getWebUrl(String url) {
//        if (!attrs.contains("buildWeb"))
//            return url;
//        else
